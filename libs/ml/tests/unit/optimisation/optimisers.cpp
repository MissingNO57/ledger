...
TYPED_TEST(OptimisersTest, sgd_optimiser_training)
{
  ...
  auto learning_rate = fetch::math::Type<fetch::fixed_point::fp32_t>("0.001");
...
TYPED_TEST(OptimisersTest, sgd_optimiser_training_2D)
{
  ...
  auto learning_rate = fetch::math::Type<fetch::fixed_point::fp32_t>("0.0001");
...
TYPED_TEST(OptimisersTest, sgd_optimiser_serialisation)
{
  ...
  auto learning_rate = fetch::math::Type<fetch::fixed_point::fp32_t>("0.06");
...
TYPED_TEST(OptimisersTest, momentum_optimiser_training)
{
  ...
  auto learning_rate = fetch::math::Type<fetch::fixed_point::fp32_t>("0.01");
...
TYPED_TEST(OptimisersTest, adagrad_optimiser_training)
{
  ...
  auto learning_rate = fetch::math::Type<fetch::fixed_point::fp32_t>("0.04");
